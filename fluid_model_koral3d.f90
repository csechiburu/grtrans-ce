...
!      shortfile=.TRUE.
      ...
      contains
		...
		!write(*,*) 'inside koral3d_vals'
		!write(*,*) 'x0%data(1): ', x0%data(1)
		!write(*,*) 'x0%data(2): ', x0%data(2)
		!write(*,*) 'x0%data(3): ', x0%data(3)
        one=1
        dzero=0d0; done=1d0; fone=1
        
        !Get unique code coordinates x1,x2,x3
        uniqx2=x2_arr(1:nx2)
		!write(*,*) 'uniqx2: ', uniqx2(:20)
        uniqx1=x1_arr(1:nx2*(nx1-1)+1:nx2)
		!write(*,*) 'uniqx1: ', uniqx1(:20)
        uniqx3=x3_arr(1:nx2*(nx1-1)*nx3+1:nx2*nx1)
		!write(*,*) 'uniqx3: ', uniqx3(:20)

        !Get unique r,phi Boyer-Lindquist coordinates
        uniqr=r0+exp(uniqx1)
		!write(*,*) 'uniqr: ', uniqr(:20)
        uniqph=uniqx3
		!write(*,*) 'uniqph: ', uniqph(:20)
        !there is no uniqth because in mks3, theta grid is r dependent!
		!write(*,*) 'past getting coordinates' 

        !Transform to Kerr-Schild x1,x2,x3 coordinates
        npts=size(x0)
        theta=x0%data(3)
		!write(*,*) 'theta: ', theta(:20) 
        zr=x0%data(2)
		!write(*,*) 'zr: ', zr(:20)
        zt=x0%data(1)
		!write(*,*) 'zt: ', zt(:20)
		!write(*,*) 'dble(zr): ', dble(zr)
		!write(*,*) 'dble(zt): ', dble(zt)
		!write(*,*) 'dble(a): ', dble(a)
		!write(*,*) 'dble(zr(1): ', dble(zr(1))
        tt=bl2ks(dble(zr),dble(zt),dble(a),1) - bl2ks(dble(zr(1)),0d0,dble(a),1)
		!write(*,*) 'tt: ', tt(:20)
        tt=-tt+1d-8
		!write(*,*) 'tt: ', tt(:20)
        !write(*,*) 'past transform to kerr-schild'
        zpp=x0%data(4)
		!write(*,*) 'zpp: ', zpp(:20)
        zphi=zpp
		!write(*,*) 'zphi: ', zphi(:20)
        ...
        !write(*,*) 'after call transformbl2mksh3'
        ...
        endwhere
		!write(*,*) 'past current-grid points'
        ...
        !write(*,*) 'past transform coordinates'
        where(ux2.ne.lx2)
        ...
        !write(*,*) 'past mask data outside region'
        ...
        bmag=sqrt(bmag)
        !write(*,*) 'past assign b components'
        ...
        !write(*,*) 'past assign u components'
        ...
        read(8,nml=harm) 
        write(6,*) 'read: ',nt
		!write(*,*) 'inside read_koral3d_inputs'
        close(unit=8)
        ...
        real(8) :: tcur
        !write(*,*) 'inside read_koral3d_data_header'
        ...
        integer :: i, nelem
        !write(*,*) 'inside read_koral3d_data_file'
        shortfile = .TRUE.
...
!             if(.not.shortfile) Be(1+i*nelem:(i+1)*nelem)=data(Bepos,:)  
        ...
        nhead=11
        !write(*,*) 'inside initialize_koral3d_model'
		...
		!write(*,*) 'nrelbin_bk: ', nrelbin_bk
		!write(*,*) 'relgammamin_bk', relgammamin_bk
		!write(*,*) 'relgammamax_bk', relgammamax_bk
        ...
        n=nx1*nx2*nx3
		!write(*,*) 'n: ', n
		!write(*,*) 'now going into init_koral3d_data'
        call init_koral3d_data(n,n*nt)
		!write(*,*) 'now going into load_koral3d_data'
        ...
        !write(*,*) 'inside load_koral3d_data'
        ...
        do k=1,nt
		   ...
		   !write(*,*) 'calling read_koral3d_data_file'
        ...
        indf=indf+nupdate
		!write(*,*) 'inside advance_koral3d_timestep'
        ...
        integer :: nshift
		!write(*,*) 'inside update_koral3d_data'
        ...
        !write(*,*) 'exiting init_koral3d_data'
